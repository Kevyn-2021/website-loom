...
export const homeCopy = {
  zh: {
    ...
    title: "KevinZ",
    intro:
      "一条从技术底层进入产品定义、GTM、全球市场和 AI 硬件的路径。这里记录的不是职位清单，而是经历如何沉淀成判断、方法和作品。",
    identity:
      "Kevin 的经验横跨芯片、手机、机器人、海外市场和创业实践。技术背景带来边界意识，商业现场训练了对价格、渠道、节奏和组织协同的敏感度。",
    capability:
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        title: "转折：全球市场训练执行感",
        body:
          "在华为终端的几年里，角色从产品经理延展到 GTM 和销售，也经历了墨西哥、秘鲁、西班牙、法国等不同市场。不同国家、客户、渠道和组织之间没有统一模板，只有把目标、资源、价格、产品和节奏重新对齐，方案才真正可执行。",
      },
      {
